...
export const legalHandler = publicHandler.parse({}).handle(async () => ({
  ...
  body:
    ...
    "<p>Open-source software, MIT licensed. Self-hosted: the operator of this instance " +
    "controls all stored data. Telegram API credentials and sessions are encrypted at rest. " +
    "Use is subject to Telegram's Terms of Service.</p>",
}));
